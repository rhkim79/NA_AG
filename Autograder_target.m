...
writecell(Results_table,'../PAres_failed_2.xls')
%
% %%
% for k = 1:5
% Int.a = test_intervals{k}(1); Int.b = test_intervals{k}(2);
% params.root_tol = 1e-10; params.func_tol = 1e-10; params.maxit = 100;
% [root, info] = modifiedbrent3031883258(test_functions{k}, Int, params)
%
% end
